...
class FormulaDistanciaTest {
	...
	void distanciaUngsMunMA() {
		Locales UNGS = new Locales ("Ungs",-34.5211588714962, -58.70075482096675);
		Locales munMA = new Locales ("Municipalidad",-34.49777838279985, -58.70136173570425);
	...
	void distanciaUngsCasaRosada() {
		Locales UNGS = new Locales ("Ungs",-34.5211588714962, -58.70075482096675);
		Locales casaRosada = new Locales ("Casa Rosada",-34.60783481920125, -58.3702456161329);
	...
	void distanciaCasaRosadaChicago() {
		Locales casaRosada = new Locales ("Casa rosada",-34.60783481920125, -58.3702456161329);
		Locales chicago = new Locales ("Chicago",41.88012882620769, -87.63594677582024);
	...
	@Test void mismaUbicacion () {
		Locales UNGS = new Locales ("Ungs",-34.5211588714962, -58.70075482096675);
		Locales UNGSCopy = new Locales ("UngsCopy",-34.5211588714962, -58.70075482096675);
